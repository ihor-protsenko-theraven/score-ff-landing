...
У матчі окремо зберігаються `touchdowns` (6 очок) і `conversions` (1 або 2 очки). Кожна подія містить команду, автора, період, час на табло та час створення. Журнал статистики не змінює рахунок автоматично: суддя й надалі коригує офіційний рахунок окремо в блоці «Активні матчі».
